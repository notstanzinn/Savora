...
export const getMyOrders = async (req, res) => {
    try {
        ...
        if (user.role == "user") {
            ...
            console.log("owner id:", req.userId)  // add this
    ...
    console.log(JSON.stringify(orders[0], null, 2))  // add this
...
export const sendDeliveryOtp = async (req,res) => {
    try {
        ...
        if(!order || !shopOrder){
            return res.status(400).json({message:"enter valid order or shoporderId"})
        }
        ...
        return res.status(200).json({message:`Delivery OTP sent successfully to ${order.user.fullName}`})
    } catch (error) {
...
export const verifyDeliveryOtp = async (req,res) => {
    try {
        ...
        if(shopOrder.deliveryOtp!==otp || shopOrder.otpExpires==null || Date.now()>shopOrder.otpExpires){
...
// groupItemsByShop{  structure of the object will be like this
//     shopId1:[
//         item1,
//         item3,
//     ],
