...
function CheckOut() {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex items-center justify-center p-6'>
                  <div className="z-10 absolute top-5 left-5" onClick={() => navigate("/")}>
                          <IoIosArrowRoundBack size={35} className="text-[#ff4d2d] " />
                  </div>
                  <div className='w-full max-w-225 bg-white space-y-6 rounded-2xl shadow-xl p-6'>
                    ...
                    <section>
                        ...
                        <div className='flex gap-2 mb-3'>
                            <input placeholder="Enter your delivery address" type="text" className='flex-1 border border-gray-300 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff4d2d]' value={addressInput} onChange={(e)=>setAddressInput(e.target.value)}/>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                            ...
                            <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition ${paymentMethod==="online"? "border-[#ff4d2d] bg-orange-50 shadow":"border-gray-200 hover:border-gray-300"}`} onClick={()=>setPaymentMethod("online")}>
                                <span className='inline-flex h-10 w-10 items-center justify-center rounded-full bg-purple-100'>
                                   <FaMobileScreenButton className='text-lg text-purple-700 '/>
                                </span>
