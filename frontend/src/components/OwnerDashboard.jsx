    ...
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
      ...
      <div className='flex justify-center items-center p-4 sm:p-6'>
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          ...
          <p className='text-gray-600 mb-4 text-sm sm:text-base'>Join our food delivery flatform and reach thousands of hungry customers evry day</p>
      ...
      <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
        <h1 className='text-2xl text-shadow-gray-900 flex items-center gap-3 mt-8 text-center'><FaUtensils className='text-[#ff4d2d] w-14 h-14'/>Welcome to {myShopData.name}</h1>
        <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
          <div className='cursor-pointer absolute top-4 right-4 bg-[#ff4d2d] text-white p-2 rounded-full shadow-md hover:bg-orange-600 transition-colors' onClick={()=>navigate("/create-edit-shop")}>
          <FaPen size={20}/>
          </div>
        ...
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          ...
          <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your delicious creations with our customers with adding the menu items</p>
      ...
      <div className='flex flex-col items-center gap-4 w-full max-w-3xl'>
        {myShopData.items.map((ite,index)=>(
          <OwnerItemCard data={ite} key={index}/>
        ))}
      </div>
      }
