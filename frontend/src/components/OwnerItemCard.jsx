  ...
  return (
    <div className='flex bg-white rounded-lg shadow-md overflow-hidden border border-[#ff4d2d] w-full max-w-2xl'>
      <div className='w-36 h-full shrink-0 bg-gray-50'>
        <img src={data.image} alt="item image" className='w-full object-cover'/>
      </div>
      <div className='flex flex-col justify-between p-3 flex-1'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <div className='cursor-pointer p-2 rounded-full hover:bg-[#ff4d2d]/10 text-[#ff4d2d]' onClick={handleDeleteItem}>
                        <FaTrashAlt size={16}/>
                    </div>
